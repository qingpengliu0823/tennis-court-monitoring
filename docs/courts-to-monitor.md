...
### 1. Garden Halls Tennis
- **System:** Microsoft Bookings (`microsoft_bookings`) — LIVE
- **Booking URL:** `https://outlook.office365.com/owa/calendar/GardenHallsTennis@upp-ltd.com/bookings/`
- **Location:** Cartwright Gardens, WC1H 9EN (~0.25 mi)
- **Courts:** 4 outdoor
- **Specs:** Service types: Garden Halls Resident (free), Student (£5), WC1 Resident (£5), Visitor (£10)

### 2. Islington Tennis Centre
- **System:** Better (`better`) — LIVE
- **Booking URL:** `https://bookings.better.org.uk/location/islington-tennis-centre/tennis-activities`
- **Location:** Market Road, N7 9PL (~1.5 mi)
- **Courts:** 6 indoor + 2 outdoor floodlit
